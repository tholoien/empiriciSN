...
class empiriciSNTestCase(unittest.TestCase):
    ...
    def test_get_SN(self):
        ...
        path='./empiriciSN_model_7comp.fit'
        urllib.urlretrieve(url, path)
        self.empiriciSN.read_model('empiriciSN_model_7comp.fit')
    ...
    def test_fit(self):
        ...
        this_model_file = self.empiriciSN.model_file
        
        self.empiriciSN.fit_from_files(['snls_master.csv'],n_components = 1)
        
        self.assertNotEqual(self.empiriciSN.model_file,this_model_file)
    ...
    def test_get_logR(self):
        ...
        logR = self.empiriciSN.get_logR(indeces,4,X)
